<template>
  <aside :class="asideClasses">
    ...
    <div v-if="!isCollapsed">
      ...
      <!-- Memory list using the MemoryItem component -->
...
<script setup lang="ts">
  ...
  import MemoryItem from './MemoryItem.vue' // adjust the path as needed
  ...
  // Simulate fetching memories with dummy data and delay
  const fetchMemories = async () => {
    ...
    memories.value = [
      {
        id: '1',
        memory: 'Learn Vue reactivity',
        updated_at: new Date().toLocaleString(),
        categories: ['Vue', 'Frontend'],
      },
      {
        id: '2',
        memory: 'Understand Nuxt auto-imports',
        updated_at: new Date().toLocaleString(),
        categories: ['Nuxt', 'SSR'],
      },
      {
        id: '3',
        memory: 'Build a memory sidebar component',
        updated_at: new Date().toLocaleString(),
